...
{
	public partial class DataUsers : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ProductPath = table.Column<string>(type: "text", nullable: false),
					CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
					UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
				},
				constraints: table =>
			...
			migrationBuilder.InsertData(
				table: "Administators",
				columns: new[] { "Id", "CreatedAt", "Description", "Email", "EmailConfirmed", "FirstName", "ImagePath", "IsHead", "LastName", "Money", "PassportNumber", "PassportSeria", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Salt", "UpdatedAt" },
				values: new object[] { 1L, new DateTime(2023, 2, 4, 18, 57, 5, 871, DateTimeKind.Utc).AddTicks(9841), "This is super admin", "SystemAdmin@gmail.com", true, "System", "", true, "Admin", 3000000.0, 1345411, "AB", "$2a$11$wflp2.VTsZmykmMsAydOa.iFXPipGum.T8d9bMa0wDKlfFV9hdbjS", "+99897436861", true, "e036118f-34b1-4955-8cdf-057bce929bcb", new DateTime(2023, 2, 4, 18, 57, 5, 871, DateTimeKind.Utc).AddTicks(9843) });
